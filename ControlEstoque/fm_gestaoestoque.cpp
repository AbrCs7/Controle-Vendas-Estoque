...
void fm_gestaoEstoque::on_btn_gravarnovoproduto_clicked()
{
    ...
    if(!query.exec()){
        ...
        QMessageBox::information(this, "Produto Cadastrado", "Produto inserido com sucesso");
...
void fm_gestaoEstoque::on_tabWidget_currentChanged(int index)
{
    if(index == 1){
        ...
        if(query.exec()){
            ...
            ui->tw_ge_produtos->setColumnWidth(1, 350);
            QStringList cabecalhos = {"Código" , "Produto"};
            ui->tw_ge_produtos->setHorizontalHeaderLabels(cabecalhos);
            ui->tw_ge_produtos->setStyleSheet("QTableView::item:selected { background-color: red; }");
...
void fm_gestaoEstoque::on_btn_ge_gravar_clicked()
{
    if(ui->txt_ge_codigoproduto->text() == ""){
        ...
        if(query.exec()){
            ...
            QMessageBox::information(this, "Atualizaçao", "Produto Atualizado com sucesso");
        }else{
    ...
    if(ui->txt_ge_codigoproduto->text() == ""){
        ...
        if(opc == QMessageBox::Yes){
            ...
            if(query.exec()){
                ...
                QMessageBox::information(this, "Deletado", "Produto excluído");
            }else{
                QMessageBox::warning(this, "Erro", "Produto não pode ser excluído");
            }
        }
    }
}
